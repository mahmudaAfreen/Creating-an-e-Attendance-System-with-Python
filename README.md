...
[**5.2. Names should describe side effects:**](https://github.com/mahmudaAfreen/Creating-an-e-Attendance-System-with-Python/blob/main/target/dist/facerecognation-1.0.dev0/attendanceproject.py#L46) The name you choose should describe what a given method, variable or class does. For example, if a function is created to search for an object and - in the case of not finding it - create a new one, it is better to use the name findOrCreate instead of just find.

[**5.3. Always delete commented-out code:**](https://github.com/mahmudaAfreen/Creating-an-e-Attendance-System-with-Python/blob/main/target/dist/facerecognation-1.0.dev0/attendanceproject.py#L1#L120) It's essential to delete commented-out code. Such code confuses readers, messes up the code, and disrupts understanding. Over time, it becomes outdated and loses meaning. Leaving it creates uncertainty, as future readers may hesitate to remove it without knowing its significance.
